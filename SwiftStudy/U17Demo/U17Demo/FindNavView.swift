...
//  U17Demo
//
//  Created by zainguo on 2020/7/20.
...
class FindNavView: UIView {
    ...
    func setupLayout() {
        ...
        stackView.snp.makeConstraints { (make) in
            make.top.equalTo(searchBtn.snp_bottomMargin).offset(10)
                ...
                if defaultValue == 0 {
                    ...
                    if changeValue > maxValue {
                        ...
                        stackView.snp.updateConstraints { (make) in
                            make.top.equalTo(searchBtn.snp_bottomMargin).offset(10 - 80/2)
                        }
                    ...
                    if changeValue >= 0 && changeValue <= 90.0 {
                        stackView.snp.updateConstraints { (make) in
                            make.top.equalTo(searchBtn.snp_bottomMargin).offset(10 - changeValue/2)
